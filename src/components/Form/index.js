...
export default function Form(){
    ...
    function calcularMedia(mediaEtapa1Format, mediaEtapa2Format){
        let mediaFinal = (Number.parseFloat(mediaEtapa1Format) + Number.
        parseFloat(mediaEtapa2Format)) / 2
        setMedia(mediaFinal)
    ...
    function validacaoMedia(){
        if(mediaEtapa1!= null && mediaEtapa2 != null){
            ...
            if (mediaEtapa1Format >= 0 && mediaEtapa2Format <= 10 &&
                mediaEtapa2Format>= 0 && mediaEtapa2Format <= 10){
